function Plane(myCanvas) {
	...
	this.defaultResizeListener = function() {
		//canvas container div is assumed to be its parent node
	...
	this.defaultMouseMoveListener = function(event) {
		...
		var xDisplay = document.getElementById("mx");
		var yDisplay = document.getElementById("my");
				
		xDisplay.innerHTML = this.mouseWorld.x;
		yDisplay.innerHTML = this.mouseWorld.y;	
